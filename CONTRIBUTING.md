...
When adding/editing case studies under `app/work/*`, follow the **Project detail page layout (standard)** and **Project detail page typography (standard)** sections in `PROJECT_STRUCTURE.md`.
