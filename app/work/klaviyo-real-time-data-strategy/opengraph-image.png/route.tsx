...
export async function GET() {
  const heroPath = "/klaviyo-events-ecosystem.jpg"
  const heroUrl = new URL("../../../../public/klaviyo-events-ecosystem.jpg", import.meta.url)
  ...
  return createProjectOgImageResponse({
    ...
    heroImageDataUrl,
    heroAlt: "The Klaviyo events ecosystem",
  })
}
