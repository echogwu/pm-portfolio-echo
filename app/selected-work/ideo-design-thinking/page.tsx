...
export const metadata: Metadata = buildMetadata({
  ...
  pathname: "/selected-work/ideo-design-thinking",
  ogImagePath: "/selected-work/ideo-design-thinking/opengraph-image.png",
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <ProjectDetailLayout
        ...
        artifacts={{ projectHref: "/selected-work/ideo-design-thinking", projectLabel: "IDEO" }}
        heroImage={{
