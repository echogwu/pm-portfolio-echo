...
export const metadata: Metadata = buildMetadata({
  ...
  pathname: "/selected-work/mba-strategic-frameworks",
  ogImagePath: "/selected-work/mba-strategic-frameworks/opengraph-image.png",
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <ProjectDetailLayout
        ...
        artifacts={{ projectHref: "/selected-work/mba-strategic-frameworks", projectLabel: "MBA" }}
        heroImage={{
          src: "/mba.gif",
