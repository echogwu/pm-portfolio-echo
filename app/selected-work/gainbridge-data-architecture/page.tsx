...
export const metadata: Metadata = buildMetadata({
  ...
  pathname: "/selected-work/gainbridge-data-architecture",
  ogImagePath: "/selected-work/gainbridge-data-architecture/opengraph-image.png",
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <ProjectDetailLayout
        ...
        artifacts={{ projectHref: "/selected-work/gainbridge-data-architecture", projectLabel: "Gainbridge" }}
        heroImage={{
          src: "/gainbridge.gif",
