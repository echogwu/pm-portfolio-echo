...
export const metadata: Metadata = buildMetadata({
  ...
  pathname: "/selected-work/dishclosure-founder-mode",
  ogImagePath: "/selected-work/dishclosure-founder-mode/opengraph-image.png",
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <ProjectDetailLayout
        ...
        artifacts={{ projectHref: "/selected-work/dishclosure-founder-mode", projectLabel: "Dishclosure" }}
        heroImage={{
          src: "/dishclosure.gif",
