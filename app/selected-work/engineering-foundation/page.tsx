...
export const metadata: Metadata = buildMetadata({
  ...
  pathname: "/selected-work/engineering-foundation",
  ogImagePath: "/selected-work/engineering-foundation/opengraph-image.png",
          ...
          right: [
            {
              ...
              description: "Treated metrics, events, and alerts as foundational infrastructure — not a post-build checklist.",
