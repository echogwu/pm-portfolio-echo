...
export const ARTIFACTS_PAGE_TITLE = "Artifacts"
export const ARTIFACTS_PAGE_DESCRIPTION =
  "Artifacts showing how I turn ambiguous product problems into decisions across value, feasibility, cost, and go-to-market."

/**
 * Artifacts are identical across job variants; only the surrounding links
 * change, so the variant renders this same shell with a prefix.
 */
export function ArtifactsPageContent({ prefix }: { prefix?: RoutePrefix }) {
  return (
    <div className="min-h-screen bg-background">
      {/* Navigation */}
      <SiteNav active="artifacts" prefix={prefix} />
